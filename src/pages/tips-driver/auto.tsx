...
function TipsDriverAuto() {
  ...
  let tipsDriverAuto: any = [];

  useEffect(() => {
    //Obtener TipsDriverAuto
    db.collection("TipsDriverAuto")
      .get()
      .then((res: any) => {
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Tips Driver sobre el Auto"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("TipsDriverAuto")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.TipsDriverAuto.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("TipsDriverAuto")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.TipsDriverAuto.onRowDelete"
                          );
                          console.log(err);
                        });
