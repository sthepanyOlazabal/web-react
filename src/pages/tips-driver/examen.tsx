...
function TipsDriverExamenes() {
  ...
  let tipsDriverExamenes: any = [];

  useEffect(() => {
    //Obtener TipsDriverExamenes
    db.collection("TipsDriverExamenes")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          tipsDriverExamenes.push({
            id: curso.id,
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Tips Driver sobre el Exámen"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("TipsDriverExamenes")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.TipsDriverExamenes.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("TipsDriverExamenes")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.TipsDriverExamenes.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default TipsDriverExamenes;
