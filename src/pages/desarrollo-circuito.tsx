...
function VideosDesarrolloCircuito() {
  ...
  let videosDesarrolloCircuito: any = [];

  useEffect(() => {
    //Obtener VideosDesarrolloCircuito
    db.collection("VideosDesarrolloCircuito")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          videosDesarrolloCircuito.push({
            id: curso.id,
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("VideosDesarrolloCircuito")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosDesarrolloCircuito.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("VideosDesarrolloCircuito")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosDesarrolloCircuito.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default VideosDesarrolloCircuito;
