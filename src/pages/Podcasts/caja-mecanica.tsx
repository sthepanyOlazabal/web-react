...
function PodcastsCajaMecanica() {
  ...
  let podcastsCajaMecanica: any = [];

  useEffect(() => {
    //Obtener PodcastsCajaMecanica
    db.collection("PodcastsCajaMecanica")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          podcastsCajaMecanica.push({
            id: curso.id,
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("PodcastsCajaMecanica")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.PodcastsCajaMecanica.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("PodcastsCajaMecanica")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.PodcastsCajaMecanica.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default PodcastsCajaMecanica;
