...
function PodcastsCajaAutomatica() {
  ...
  let podcastsCajaAutomatica: any = [];

  useEffect(() => {
    //Obtener PodcastsCajaAutomatica
    db.collection("PodcastsCajaAutomatica")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          podcastsCajaAutomatica.push({
            id: curso.id,
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Podcasts Caja Automática"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("PodcastsCajaAutomatica")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.PodcastsCajaAutomatica.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("PodcastsCajaAutomatica")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.PodcastsCajaAutomatica.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default PodcastsCajaAutomatica;
