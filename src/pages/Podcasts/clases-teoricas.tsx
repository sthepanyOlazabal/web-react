...
function PodcastsClasesTeoricas() {
  ...
  let podcastsClasesTeoricas: any = [];

  useEffect(() => {
    //Obtener PodcastsClasesTeoricas
    db.collection("PodcastsClasesTeoricas")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          podcastsClasesTeoricas.push({
            id: curso.id,
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Podcasts Clases Teóricas"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("PodcastsClasesTeoricas")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.PodcastsClasesTeoricas.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("PodcastsClasesTeoricas")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.PodcastsClasesTeoricas.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default PodcastsClasesTeoricas;
