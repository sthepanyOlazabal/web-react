...
function VideosMecanicaPreventiva() {
  ...
  let videosMecanicaPreventiva: any = [];

  useEffect(() => {
    //Obtener VideosMecanicaPreventiva
    db.collection("VideosMecanicaPreventiva")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          videosMecanicaPreventiva.push({
            id: curso.id,
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Videos de Teoría sobre Mecánica Preventiva"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("VideosMecanicaPreventiva")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosMecanicaPreventiva.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("VideosMecanicaPreventiva")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosMecanicaPreventiva.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default VideosMecanicaPreventiva;
