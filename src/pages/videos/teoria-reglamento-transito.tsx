...
function VideosReglamentoTransito() {
  ...
  let videosReglamentoTransito: any = [];

  useEffect(() => {
    //Obtener VideosReglamentoTransito
    db.collection("VideosReglamentoTransito")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          videosReglamentoTransito.push({
            id: curso.id,
        ...
        setState({
          columns: [
            ...
            { title: "Enlace del video", field: "enlace" },
            { title: "Activo", field: "activo", type: "boolean" },
          ],
          data: videosReglamentoTransito,
        });
      });
  }, []);
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Videos de Teoría sobre el Reglamento de Tránsito"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("VideosReglamentoTransito")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosReglamentoTransito.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("VideosReglamentoTransito")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosReglamentoTransito.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default VideosReglamentoTransito;
