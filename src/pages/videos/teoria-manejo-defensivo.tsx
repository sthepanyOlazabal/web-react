...
function VideosManejoDefensivo() {
  ...
  let videosManejoDefensivo: any = [];

  useEffect(() => {
    //Obtener VideosManejoDefensivo
    db.collection("VideosManejoDefensivo")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          videosManejoDefensivo.push({
            id: curso.id,
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Videos de Teoría sobre Manejo Defensivo"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("VideosManejoDefensivo")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosManejoDefensivo.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("VideosManejoDefensivo")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosManejoDefensivo.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default VideosManejoDefensivo;
