...
function VideosCajaAutomatica() {
  ...
  let videosCajaAutomatica: any = [];

  useEffect(() => {
    //Obtener VideosCajaAutomatica
    db.collection("VideosCajaAutomatica")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          videosCajaAutomatica.push({
            id: curso.id,
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Videos de Prácticas de Caja Automática"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("VideosCajaAutomatica")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosCajaAutomatica.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("VideosCajaAutomatica")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosCajaAutomatica.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default VideosCajaAutomatica;
