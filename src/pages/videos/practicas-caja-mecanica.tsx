...
function VideosCajaMecanica() {
  ...
  let videosCajaMecanica: any = [];

  useEffect(() => {
    //Obtener VideosCajaMecanica
    db.collection("VideosCajaMecanica")
      .get()
      .then((res: any) => {
        res.forEach((curso: any) => {
          videosCajaMecanica.push({
            id: curso.id,
  ...
  return (
    <div className="App">
      <div className="App-header">
        <div>
          <MaterialTable
            title="Videos de Prácticas de Caja Mecánica"
                    ...
                    if (oldData) {
                      setState((prevState: TableState) => {
                        ...
                        db.collection("VideosCajaMecanica")
                          ...
                          .catch((err) => {
                            alert(
                              "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosCajaMecanica.onRowUpdate"
                            );
                            console.log(err);
                          });
                        return { ...prevState, data };
                  ...
                  setTimeout(() => {
                    ...
                    setState((prevState: TableState) => {
                      ...
                      db.collection("VideosCajaMecanica")
                        ...
                        .catch((err) => {
                          alert(
                            "Ocurrió un error, por favor contactar con el administrador del sistema.\nError: Table.VideosCajaMecanica.onRowDelete"
                          );
                          console.log(err);
                        });
...
export default VideosCajaMecanica;
